...
.login-wrapper{min-height:100vh;min-height:var(--app-height,100dvh);display:flex;align-items:center;justify-content:center;padding:18px;background:radial-gradient(circle at top left,rgba(244,228,204,.18),transparent 24%),radial-gradient(circle at right top,rgba(227,187,122,.24),transparent 32%),linear-gradient(180deg,#fffaf3 0%,#f4e9dc 100%)}
