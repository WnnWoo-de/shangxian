...
.helper-row{display:flex;justify-content:space-between;gap:10px;font-size:12px;color:$text-muted}.error-message{padding:12px 14px;border-radius:14px;background:rgba(201,79,67,.08);border:1px solid rgba(201,79,67,.2);color:$error;font-size:14px}.btn-login{width:100%;height:54px;border:none;border-radius:999px;background:linear-gradient(135deg,#f4e3ca 0%,#e7c797 100%);color:#7f6248;font-size:16px;font-weight:700;cursor:pointer;box-shadow:0 16px 28px rgba(227,187,122,.22);transition:transform $transition-fast,box-shadow $transition-normal}.btn-login:hover:not(:disabled){transform:translateY(-1px);box-shadow:0 22px 34px rgba(227,187,122,.26)}.btn-login:disabled{opacity:.72;cursor:not-allowed}
