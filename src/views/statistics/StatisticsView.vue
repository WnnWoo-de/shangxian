        ...
        <div class="ledger-list">
          ...
          <div v-for="item in animatedPagedLedger" :key="item.day" class="ledger-row">
            ...
            <div class="ledger-values">
              ...
              <span class="net-text" :class="item.net >= 0 ? 'income-text' : 'expense-text'">
    ...
    <div class="content-grid bottom-grid">
      <article class="panel">
        ...
        <div class="table-wrapper">
          <table>
            <thead>
              <tr><th>排名</th><th>对象</th><th>单据数</th><th>总重量</th><th>支出金额</th></tr>
            </thead>
            <tbody>
              <tr v-if="loading"><td colspan="5" class="empty">统计数据加载中...</td></tr>
              <tr v-else-if="expenseByCustomer.length === 0"><td colspan="5" class="empty">暂无对象交易数据</td></tr>
      ...
      <article class="panel">
        ...
        <div class="category-list">
          ...
          <div v-for="item in expenseByFabric" :key="item.fabricName" class="category-row">
            ...
            <div class="bar-track">
              <div class="bar-fill category-fill" :class="{ ready: barMotionReady }" :style="{ width: `${barMotionReady ? item.ratio : 0}%` }"></div>
            </div>
